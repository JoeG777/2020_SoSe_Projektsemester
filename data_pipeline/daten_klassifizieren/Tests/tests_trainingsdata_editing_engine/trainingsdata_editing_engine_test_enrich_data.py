...
class test_enrich_data(unittest.TestCase):
    ...
    def test_read_wrong_database_name(self):
        wrong_config_test = copy.deepcopy(config)
        wrong_config_test["datasource_raw_data"]["database"] = "falseName"
        self.assertRaises(DBException, trainingsdata.enrich_data, wrong_config_test)
